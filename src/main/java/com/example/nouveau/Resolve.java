...
public class Resolve {
    ...
    public Resolve(Maze Labyrinthe) {
        this(Labyrinthe, Labyrinthe.getMaze()[0][0], Labyrinthe.getMaze()[Labyrinthe.getHeight()-1][Labyrinthe.getWidth()-1] ); // Call the main constructor with entry and exit null
    }
    ...
    public List<Case> BFS(boolean stepByStep) {
        ...
        parentMap = new HashMap<>();// Map to keep track of the parent of each cell
